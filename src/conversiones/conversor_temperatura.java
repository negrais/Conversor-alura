...
public class conversor_temperatura {
	public void obtener_datos() {
		...
		Object opciones_elegir_temperatura = JOptionPane.showInputDialog(null,"Seleccione un opción de conversión", "Menu",JOptionPane.QUESTION_MESSAGE,new ImageIcon("src/img/icon1.png"),opciones_temperatura, opciones_temperatura[0]);
